...
class Evaluator(object):
    def __init__(self, figure_name):
        ...
        self.win = figure_name

    def append_plot(self, value, step):
        self.viz.line([value], [step], win=self.win, update='append',
                      opts=dict(xlabel='step', ylabel='value', title='convergence'))
